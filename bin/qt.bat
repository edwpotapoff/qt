@REM qt launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM QT_config.txt found in the QT_HOME.
...
set "CFG_FILE=%APP_HOME%\QT_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running qt.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !QT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
